...
export { default as pluginOxfmt } from 'eslint-plugin-oxfmt'
...
export { default as pluginVuePerfectionist } from 'eslint-plugin-vue-perfectionist'
export * as pluginESLintComments from '@eslint-community/eslint-plugin-eslint-comments'
